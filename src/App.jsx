            ...
            <Routes>
              ...
              <Route element={<ProtectedRoute allowedRoles={['retailer']} />}>
                <Route path="/retailer" element={<RequireOnboarding />}>
                  ...
                  <Route path="dashboard" element={<Layout title="Mera Business" role="retailer" width="wide"><RetailerDashboard /></Layout>} />
                  <Route path="profile" element={<Layout title="Mera Profile" role="retailer" showBack width="narrow"><RetailerProfile /></Layout>} />
                  <Route path="profile/edit" element={<Layout title="Profile Edit" role="retailer" showBack width="narrow"><EditProfile /></Layout>} />
                  <Route path="developer-pack" element={<Layout title="Developer Pack" role="retailer" showBack width="wide"><RetailerDeveloperPack /></Layout>} />
                  <Route path="distributors" element={<Layout title="Nearby Distributors" role="retailer" showBack width="wide"><DistributorDiscovery /></Layout>} />
                  <Route path="distributors/:distributorId" element={<Layout title="Distributor Catalogue" role="retailer" showBack width="wide"><RetailerDistributorCatalogue /></Layout>} />
                  ...
                  <Route path="report-demand" element={<Layout title="Kya Nahi Mila?" role="retailer" showBack width="narrow"><ReportDemand /></Layout>} />
              ...
              <Route element={<ProtectedRoute allowedRoles={['distributor']} />}>
                <Route path="/distributor" element={<RequireOnboarding />}>
                  ...
                  <Route path="dashboard" element={<Layout title="Mera Business" role="distributor" width="wide"><DistributorDashboard /></Layout>} />
                  <Route path="profile" element={<Layout title="Mera Profile" role="distributor" showBack width="narrow"><DistributorProfile /></Layout>} />
                  <Route path="profile/edit" element={<Layout title="Profile Edit" role="distributor" showBack width="narrow"><EditProfile /></Layout>} />
                  <Route path="opportunities" element={<Layout title="Business Opportunities" role="distributor" showBack width="wide"><OpportunitiesList /></Layout>} />
                  ...
                  <Route path="catalogue" element={<Layout title="Meri Catalogue" role="distributor" width="wide"><DistributorCatalogue /></Layout>} />
