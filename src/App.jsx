        ...
        <main className="main-content">
          <Routes>
            ...
            <Route path="/distributor" element={<Outlet />}>
              ...
              <Route path="opportunities" element={<Layout title="Business Opportunities" role="distributor" showBack><PlaceholderPage title="Opportunities" description="Aapke area mein jahan demand aur supply ke beech gap hai." /></Layout>} />
