  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in">
      <div className="text-center mt-4">
        <h2 className="text-2xl font-bold text-text-primary">Aapke business ke baare mein thoda samajhte hain</h2>
        <p className="text-text-muted mt-2">Apni details confirm karein</p>
      </div>
